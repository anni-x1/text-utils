  ...
  return (
    <>
      <div className='container my-2'>
        ...
        <textarea  id="textbox1" className={`form-control ${props.mod}-text-area`} name="mybox" onChange={handleOnChange} placeholder='paste your text here' value={text} rows={10} /><br />
